...
>[] = [
  {
    ...
    description:
      'An e-commerce website that manages records of items, orders, blogs, etc',
  ...
  },
  {
    ...
    description:
      'A Laguna Lake Development Authority (LLDA) Website for applying online clearance application',
    developmentType: 'Full Stack',
    technologies: [
      skills.language.skills[0].name,
      skills.language.skills[1].name,
  ...
  },
  {
    ...
    description:
      'An internal website of the company for the project management tool',
    developmentType: 'Full Stack',
    technologies: [
      skills.language.skills[0].name,
      skills.language.skills[1].name,
  ...
  },
  {
    ...
    description:
      'A DSWD website for booking and certification for minors traveling abroad',
    developmentType: 'Full Stack',
    technologies: [
      skills.language.skills[0].name,
      skills.language.skills[1].name,
  ...
  },
  {
    title: 'Greenbox',
    description:
      'A web-based application for manage records of merchant for customer service employees',
    developmentType: 'Full Stack',
    technologies: [
      skills.language.skills[0].name,
      skills.language.skills[1].name,
  ...
  },
  {
    ...
    description:
      'A thesis proposal system for our target client of Puerto Princesa Auto Supply to automate the process of sales and inventory system',
    developmentType: 'Full Stack',
    technologies: [
