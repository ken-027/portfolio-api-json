...
const restAPI: Omit<IWork, 'website' | 'images'>[] = [
  {
    title: 'Portfolio',
    description:
      'A portfolio api that has jwt authentication, api key authentication, image uploading, validtion, etc',
  ...
  },
  {
    title: 'Recipe',
    description:
      'A recipe rest API that has uploading images, authentication, authorization, etc',
    developmentType: 'Backend',
  ...
  },
  {
    title: 'User',
    description:
      'A simple Create, Read, Update and Delete (CRUD) application of nodejs',
    developmentType: 'Backend',
  ...
  },
  {
    title: 'Order',
    description:
      'A simple Order API with authentication, validation and unit testing',
    developmentType: 'Backend',
