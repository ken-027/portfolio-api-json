...
const extraPrograms: Omit<IWork, 'website' | 'images' | 'developmentType'>[] = [
  {
    ...
    description:
      'A simple typescript console application that has different algorithms',
  ...
  },
  {
    ...
    description:
      'A simple python console application that has a calculator and rock paper scissor game, and other related mini modules',
  ...
  },
  {
    title: 'Rust Console',
    description:
      'A simple rust console application that has exercises and a guessing game',
  ...
  },
  {
    ...
    description:
      'A simple click me react application integrated with laravel api',
